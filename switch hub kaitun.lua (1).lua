...
if _G.Switch_Hub_Series_R then
	...
	spawn(function()
		if _G.Main and _G.Main['FPS Booster'] then
			...
			if shared.BC_1 and shared.BC_2 == nil then
				...
				-- Cấu hình các đối tượng trong Workspace
				...
				-- Cấu hình các đối tượng trong Lighting
				...
				if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then -- Blox Fruits
					...
					if effectContainer then
						...
						if sharedEffects then
							sharedEffects:FindFirstChild("AirDash") and sharedEffects.AirDash:Destroy()
							sharedEffects:FindFirstChild("LightningTP") and sharedEffects.LightningTP:Destroy()
						end
	
						local miscEffects = effectContainer:FindFirstChild("Misc")
						if miscEffects then
							miscEffects:FindFirstChild("Damage") and miscEffects.Damage:Destroy()
							miscEffects:FindFirstChild("Confetti") and miscEffects.Confetti:Destroy()
						end
	
						effectContainer:FindFirstChild("LevelUp") and effectContainer.LevelUp:Destroy()
					end
				end
	...
	-- Đợi 3 giây trước khi thiết lập vũ khí
	wait(3)
	local Weapon = 'Combat'
